...
```
curl -X GET http://localhost:9090/reservations
...
```
curl -X GET http://localhost:9090/reservation/1234
...
```
curl -X POST -d '{"reservationCreator": "John Doe", "reservationId": "111", "contact": "011-123-1111"}' http://localhost:9090/reservation/1111
...
```
curl -X PUT http://localhost:9090/reservation/1234 -d '{"reservationCreator": "Lahiru C", "reservationId": "1234", "contact": "011-123-4588"}' 
...
```
curl -X DELETE http://localhost:9090/reservation/1234
